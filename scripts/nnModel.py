...
class NNModel(BaseNNModel):
    """
        ...
        Attributes:
        - dense_layers (tuple): Tuple specifying the number of neurons in each dense layer.
        - activations (tuple): Tuple specifying the activation function for each dense layer.
